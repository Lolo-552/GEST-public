...
! function (n) {
    ...
    var Ie = [],
        ...
        He = (e("columns()", function (n, a) {
        ...
        }), C.version = "1.13.2", C.settings = [], C.models = {}, C.models.oSearch = {
            bCaseInsensitive: !0,
            sSearch: "",
            bRegex: !1,
            bSmart: !0,
            ...
            oLanguage: {
                ...
                sInfo: "Pokazywanie _START_ do _END_ z _TOTAL_ wierszy",
                sInfoEmpty: "Brak wierszy",
                sInfoFiltered: "(przefiltrowano _MAX_ wierszy)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
            ...
            for (var t, n, r = function (e) {
                ...
                if (t = a[i], Array.isArray(t)) u(e, t);
                    ...
                    p && (n = -1 !== f.indexOf("disabled"), n = x("<li>", {
                        ...
                        id: 0 === o && "string" == typeof t ? d.sTableId + "_" + t : null
                    }).append(x("<a>", {
                        href: n ? null : "#",
